...
% função complementar de 12. Print nome do carro.
aux12(N,S) :- auto(_,_,N,S,M,Mol,_,_,_,_,_,_,_,_,_),
              tab(10),write('Tem 1 '),tab(4),write(M),
              write(' '),tab(4),write(Mol),nl,fail.
...
% 12.
menu_editar(Pl) :-
    retract(auto(R,Pl,N,S,Mar,M,A,_,_,_,_,_,_,C,T)),
    nl,
    write('Redefina os seguintes dados: '),nl,
    tab(10),write('Logradouro: '),tab(10),read(L),
    tab(10),write('Número: '),tab(10),read(Num),
    tab(10),write('Complemento: '),tab(10),read(Com),
    tab(10),write('CEP: '),tab(10),read(Cep),
    tab(10),write('Cidade: '),tab(10),read(Cid),
    tab(10),write('Estado: '),tab(10),read(Est),
    nl,
    assert(auto(R,Pl,N,S,Mar,M,A,L,Num,Com,Cid,Est,Cep,C,T)),
    nl,tab(4),write('Dados do automóvel foram redefinidos.').
...
chama(7) :-
    ...
    nl,nl,
    quantidade_auto(auto(_,_,_,_,_,_,_,_,_,_,_,_,_,_,_),Count),tab(4),
...
chama(12) :-
    nl,write('(12) Menu de Cadastro de Automóveis.'),
    nl,
    nl,write('Digite a Placa: '),tab(10),read(Pl),
    menu_editar(Pl), recall.
...
start :-
    ...
    tab(10),write('(12) Menu de Cadastro de Automóveis.'),nl,
    nl,
    write('---------------------------------'),nl,
    nl,
