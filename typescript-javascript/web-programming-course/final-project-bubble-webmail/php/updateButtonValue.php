...
<?php 
	...
	$password = $xml_objeto->password[0];
	...
	if($buttonName == "btTabBar"){  $options1 = $value; }
	elseif($buttonName == "btFavorites"){  $options2 = $value; }
	elseif($buttonName == "btInbox"){  $options3 = $value;	}
	elseif($buttonName == "btJunkMail"){  $options4 = $value;	}
	elseif($buttonName == "btDrafts"){  $options5 = $value; }
	elseif($buttonName == "btSentItems"){  $options6 = $value; }
	elseif($buttonName == "btDeletedItems"){  $options7 = $value; }
	elseif($buttonName == "btArchive"){  $options8 = $value; }
