...
public class arv_bin_S {
    ...
    static String[] palavras(String path) throws FileNotFoundException{
        ...
        while(i.hasNext()){
            ...
            h[j] = formatar(i.next()).toString().toLowerCase();
            j++;    
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        arv_bin_S tree4 = new arv_bin_S();
        arv_bin_S tree5 = new arv_bin_S();
        
        
        String path1 = "C:\\Users\\Gustavo\\"
             + "Documents\\NetBeansProjects\\Contador\\"
             + "build\\classes\\árvore\\arquivo1.txt";

        String path2 = "C:\\Users\\Gustavo\\"
             + "Documents\\NetBeansProjects\\Contador\\"
             + "build\\classes\\árvore\\arquivo2.txt";
        
        String path3 = "C:\\Users\\Gustavo\\"
             + "Documents\\NetBeansProjects\\Contador\\"
             + "build\\classes\\árvore\\arquivo3.txt";
       
        String path4 = "C:\\Users\\Gustavo\\"
             + "Documents\\NetBeansProjects\\Contador\\"
             + "build\\classes\\árvore\\arquivo4.txt";
        
        String path5 = "C:\\Users\\Gustavo\\"
             + "Documents\\NetBeansProjects\\Contador\\"
             + "build\\classes\\árvore\\arquivo5.txt";
        
        tree1.to_arv_bin_S(path1);
        tree2.to_arv_bin_S(path2);
        tree3.to_arv_bin_S(path3);
        tree4.to_arv_bin_S(path4);
        tree5.to_arv_bin_S(path5);
        ...
        if(false){ 
            ...
            System.out.print("\nTree 4:");
            tree4.imprimir_ordem();
            System.out.print("\nTree 5:");
            tree5.imprimir_ordem();
        }
        ...
        while(true){
            ...
            tree4.ocorrêcias(tree4, path4, palavra);
            tree5.ocorrêcias(tree5, path5, palavra);
