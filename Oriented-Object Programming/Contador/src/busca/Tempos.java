...
public class Tempos {   
    ...
    public static void main(String[] args) throws InterruptedException, Exception{
        ...
        int[] chaves_busca = criar_array.mach_vektor((int)(n * 1.25));
        ...
        procura_tree(tree,array);// Procura em árvore. Rec.
        long arvRecFim = System.currentTimeMillis();
        /////////////////////////////////////////////////
        long bbRec = System.currentTimeMillis();
        procura_bb(x, array);// Procura em vetor. Rec.
        ...
        "Tempo de pesquisa(chaves_busca) em árvore de todos "+"os elementos do vetor: "+
        P_tree+" milisegundos ("+P_tree/1000.0+" segundos).\n\n"+
        "Tempo de pesquisa(chaves_busca) em vetor de todos os elementos do vetor: "+
        P_bb+" milisegundos ("+P_bb/1000.0+" segundos).\n\n\n\n"+
        "Tempo de recuperação de todas as chaves em árvore de todos "+"os elementos do vetor: "+
        Rec_tree+" milisegundos ("+Rec_tree/1000.0+" segundos).\n\n"+
        "Tempo de recuperação de todas as chaves em vetor de todos os elementos do vetor: "+
        Rec_bb+" milisegundos ("+Rec_bb/1000.0+" segundos).\n\n\n\n"+
        "Tempo de ordenação e recuperação em vetor: "+(OrdenarTempo+Rec_bb)+
        " milisegundos ("+(OrdenarTempo+Rec_bb)/1000.0+" segundos).\n\n"+
        ...
        (OrdenarTempo+Rec_bb+arvConstruir+Rec_tree)+" milisegundos ("+
        (OrdenarTempo+Rec_bb+arvConstruir+Rec_tree)/1000.0+" segundos)."
        +"\n\n\n\n"+            
