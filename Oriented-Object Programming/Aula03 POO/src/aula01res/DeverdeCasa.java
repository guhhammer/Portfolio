...
public class DeverdeCasa {
    ...
    public static void MatrizExercicio6(int rowM, int columnM, float[][] M){
        
        float divisor = M[0][0];
        float[] listaDivisor = new float[rowM];
        float[][] mod = new float[rowM][columnM];
    ...
    public static void main(String []args){
        ...
        */
        ...
        int rowM = 5;
        int columnM = 5;
        float [][] M =  new float[rowM][columnM];
