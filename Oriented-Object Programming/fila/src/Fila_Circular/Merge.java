...
public class Merge {
    ...
    //  Uso: exemplo de uma fila usando inserir() e remover().
    public static void exemplo_fila_qualquer(){
        FilaC x = new FilaC(8);
        x.inserir(2);
        x.inserir(3);
        x.inserir(4);
        System.out.println("Primeiro: "+x.primeiro()+"\nÚltimo: "+x.ultimo());
        x.inserir(5);
        x.inserir(6);
        x.inserir(7);
        x.inserir(8);
        ...
        System.out.println("Primeiro: "+x.primeiro()+"\nÚltimo: "+x.ultimo());
        print_ordem(x);
        print_ordem(enxuto(f()));
        print_ordem(enxuto(x));
        print_merge(enxuto(x),f());
