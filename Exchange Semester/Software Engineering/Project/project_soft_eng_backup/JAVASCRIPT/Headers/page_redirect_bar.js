$(document).ready(function(){
	...
	if(("training" == url || "my_training" == url || "create_event_training" == url)){
		...
		$("#b_training_options").append(redirect);
	...
	// -------------------------------------------------------------------------------------------------------
		...
		$("#b_chits_options").append(redirect);
	...
	// -------------------------------------------------------------------------------------------------------
		...
		$("#b_leadership_options").append(redirect);
	...
	// -------------------------------------------------------------------------------------------------------
		...
		$("#b_watchbill_options").append(redirect);
	...
	// -------------------------------------------------------------------------------------------------------
		...
		$("#b_documents_options").append(redirect);
