<?php 
	...
	function get_service_information($userID, &$status){

		$program_value = "MECEP".""; 
		$prog_st_value = "Active"."";  
		$rank_value = "SSgt"."";  
		$serv_op_value = "Navy".""; 
		$contract_value = "Air"."";

		/* TO BE DONE
		getValues( [&$program_value, &$prog_st_value, &$rank_value, &$serv_op_value, &$contract_value],
				   ["program", "programState", "rank", "serviceOption", "contract"],
				    "some-table", 
				   [["id", $id]],
				    $divs["service"]
				 );
