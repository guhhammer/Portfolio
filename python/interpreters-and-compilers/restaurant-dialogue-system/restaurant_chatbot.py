...
def stepTablesToReserve():
    ...
    available = True # check availability here; placeholder for now.
    ...
    if(available): #verify if table is available
        ...
        print("Would you like to select another table [yes/no]?")
...
reserveAvailability = True # check whether at least one table is free; placeholder for now.
...
def stepEnterAddress():
    ...
    if(len(myAddress) > 1):
        ...
        print("\nThe address given is not valid. Enter your Address:\n")
        stepEnterAddress()
...
def stepMakeARequest():
    ...
    isOnTheMenu = True # check whether the dish is on the menu; placeholder for now.
    if(isOnTheMenu):

        print("\nAre you sure about your request [yes/no]?\n")
        ...
        if(sureAbout == "yes"):
            ...
            if(seeMenuAgain == "yes"):
                ...
                print("\nWould you like to cancel this request [yes/no]?\n")
        ...
        print("\nWould you like to select another dish [yes/no]?\n")
...
while(on):
    ...
    print("\nHello, I will be your manager for today. May I help you?\n")
