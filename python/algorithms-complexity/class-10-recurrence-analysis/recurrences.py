...
# arr -> n / 4 | n <- n * 2  (each call doubles A and recurses on four quarters)
"""
 	...
 	call 1 -> A=16 :: 4 calls -> A=8
	call 2 -> A=32 :: 32 calls -> A=4
	call 3 -> A=64 :: 128 calls -> A=2
