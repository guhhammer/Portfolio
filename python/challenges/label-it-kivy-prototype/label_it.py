""""Label it": Kivy prototype of a mobile app for labelling meme images, with a main grid of pictures, gallery, camera and settings screens switched through a bottom bar (2019 side project)."""
import kivy
