"""Run the mask detector trained by mask_detector_train.py on the webcam (class demo).

Each detected face is classified as with / without mask and the label and confidence are drawn on the frame. Press q to quit.
"""
import cv2
