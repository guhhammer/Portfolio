"""Baseline: logistic regression on seven hand-picked columns, exporting the default probabilities of the test set (team JPB naming)."""
import pandas as pd
...
prob = [x[1] for x in prob] # keep only the probability of class 1 (default)
