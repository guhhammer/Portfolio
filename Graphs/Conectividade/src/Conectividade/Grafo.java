...
public class Grafo{
    ...
    List getComponentes(){ return BuscaLargura.componentesGrafo(this); }
    
    // Retorna o número de componentes do grafo.
    int quantidadeComponentes(){
        return BuscaLargura.componentesGrafo(this).size();
    }
    
    // imprime apenas os componentes.
    void printOnlyComponentes(){
        BuscaLargura.printOnlyComponentes(BuscaLargura.componentesGrafo(this));
    }
    
    // imprime os componentes e a quantidade.
    void printComponentes(){ 
        BuscaLargura.printComponentes(BuscaLargura.componentesGrafo(this));
    }   
