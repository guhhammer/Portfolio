...
public class Thread4 extends Thread{
    ...
    public Thread4(Semaphore m1, Semaphore m2, Semaphore m3, Semaphore m4){
        this.mutex1 = m1;
        this.mutex2 = m2;
        this.mutex3 = m3;
        this.mutex4 = m4;
    ...
    public void run(){
        try{
            ...
            mutex1.acquire();
                ...
                for(int i = parte4; i < funcionario.length-1; i++){
                    funcionario[i].planoDeSaude();
                }
                System.out.println("\nPlano de Saúde (Parte 4): feito.\n");
            ...
            String path = "src\\Barreira\\Parte 4.txt";
            File criar4 = new File(path);
