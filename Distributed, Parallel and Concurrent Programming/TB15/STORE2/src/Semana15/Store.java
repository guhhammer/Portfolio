...
public class Store {
    ...
    private static String IDStore = "StoreB";

    public static void main(String[] args) throws UnknownHostException {

        getEstoque().add(new Product("LG SmartTV",8000.0f));
        getEstoque().add(new Product("IPOD 3",1990.90f));
        getEstoque().add(new Product("Mac Pro", 4500.0f));
        getEstoque().add(new Product("Dell Inspirion 15",3800.0f));
        getEstoque().add(new Product("Samsung SmartTv", 500.0f));
