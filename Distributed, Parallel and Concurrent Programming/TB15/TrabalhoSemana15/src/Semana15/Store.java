...
public class Store {
    ...
    private static String IDStore = "StoreA";

    public static void main(String[] args) throws UnknownHostException {

        getEstoque().add(new Product("Iphone X",3200.0f));
        getEstoque().add(new Product("Iphone X",3250.0f));
        getEstoque().add(new Product("Samsung S9", 3000.0f));
        getEstoque().add(new Product("Xiaomi 3",1900.0f));
        getEstoque().add(new Product("Motorola M4", 500.0f));
