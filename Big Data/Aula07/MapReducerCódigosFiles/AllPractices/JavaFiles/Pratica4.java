...
public class Pratica4 {
    ...
    public static class MapperImplementacao4 extends Mapper<Object, Text, Text, IntWritable>{
        ...
        public void map(Object chave, Text valor, Context context) throws IOException, InterruptedException {
            ...
            context.write(new Text(valor.toString().split(";")[3]), new IntWritable(1));
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        String arquivoSaida = System.getProperty("user.home") + "/Desktop/" + Pratica4.class.getSimpleName();
        if(args.length == 2){
            arquivoEntrada = args[0];
            arquivoSaida = args[1];
        }
        Configuration conf = new Configuration();
        Job job = Job.getInstance(conf, String.valueOf(Pratica4.class.getSimpleName()));

        job.setJarByClass(Pratica4.class);
