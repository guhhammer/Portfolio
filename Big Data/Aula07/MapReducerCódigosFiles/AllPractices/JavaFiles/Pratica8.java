...
public class Pratica8 {
    ...
    public static class MapperImplementacao8 extends Mapper<Object, Text, Text, LongWritable>{
    ...
    public static class ReducerImplementacao8 extends Reducer<Text, LongWritable, Text, LongWritable> {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        String arquivoSaida = System.getProperty("user.home") + "/Desktop/" + Pratica8.class.getSimpleName();
        if(args.length == 2){
            arquivoEntrada = args[0];
            arquivoSaida = args[1];
        }
        Configuration conf = new Configuration();
        Job job = Job.getInstance(conf, String.valueOf(Pratica8.class.getSimpleName()));

        job.setJarByClass(Pratica8.class);
