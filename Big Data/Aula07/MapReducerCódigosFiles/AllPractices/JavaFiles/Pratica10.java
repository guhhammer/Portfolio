...
public class Pratica10 {
    ...
    public static class MapperImplementacao10 extends Mapper<Object, Text, Text, LongWritable>{
        ...
        public void map(Object chave, Text valor, Context context) throws IOException, InterruptedException {
            ...
            if(b[0].trim().contains("Brazil")){
                try{
                    context.write(new Text("<"+b[3]+", "+b[1]+">"),
                                  new LongWritable(Long.parseLong(b[6])));
    ...
    public static class ReducerImplementacao10 extends Reducer<Text, LongWritable, Text, LongWritable> {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        String arquivoSaida = System.getProperty("user.home") + "/Desktop/" + Pratica10.class.getSimpleName();
        if(args.length == 2){
            arquivoEntrada = args[0];
            arquivoSaida = args[1];
        }
        Configuration conf = new Configuration();
        Job job = Job.getInstance(conf, String.valueOf(Pratica10.class.getSimpleName()));

        job.setJarByClass(Pratica10.class);
        job.setMapperClass(MapperImplementacao10.class);
        job.setReducerClass(ReducerImplementacao10.class);
