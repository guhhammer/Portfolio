...
public class Pratica7 {
    ...
    public static class MapperImplementacao7 extends Mapper<Object, Text, Text, LongWritable>{
        ...
        public void map(Object chave, Text valor, Context context) throws IOException, InterruptedException {
            ...
            try {
                ...
                context.write(new Text(b[3]), new LongWritable(p));
            }catch (Exception e) {
                //e.printStackTrace();
            }
    ...
    public static class ReducerImplementacao7 extends Reducer<Text, LongWritable, Text, LongWritable> {
        public void reduce(Text chave, Iterable<LongWritable> valores, Context context) throws IOException, InterruptedException {

            long qt = 0;
            for(LongWritable v: valores){ qt = qt + v.get(); }
            context.write(chave, new LongWritable(qt));
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        String arquivoSaida = System.getProperty("user.home") + "/Desktop/" + Pratica7.class.getSimpleName();
        if(args.length == 2){
            arquivoEntrada = args[0];
            arquivoSaida = args[1];
        }
        Configuration conf = new Configuration();
        Job job = Job.getInstance(conf, String.valueOf(Pratica7.class.getSimpleName()));

        job.setJarByClass(Pratica7.class);
