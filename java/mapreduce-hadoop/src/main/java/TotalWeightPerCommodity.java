...
/**
 * Practice 7: total traded weight (kg) per commodity.
 *
 ...
 */
public class TotalWeightPerCommodity {
    ...
    public static class TradeMapper extends Mapper<Object, Text, Text, LongWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            try {
                ...
                context.write(new Text(cols[3]), new LongWritable(weight));
            } catch (Exception e) {
    ...
    public static class TradeReducer extends Reducer<Text, LongWritable, Text, LongWritable> {
        ...
        public void reduce(Text key, Iterable<LongWritable> values, Context context) throws IOException, InterruptedException {
            long total = 0;
            for (LongWritable v : values) { total += v.get(); }
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        String outputPath = System.getProperty("user.home") + "/Desktop/" + TotalWeightPerCommodity.class.getSimpleName();
        if (args.length == 2) {
            inputPath = args[0];
            outputPath = args[1];
        }

        Job job = Job.getInstance(new Configuration(), TotalWeightPerCommodity.class.getSimpleName());
        job.setJarByClass(TotalWeightPerCommodity.class);
