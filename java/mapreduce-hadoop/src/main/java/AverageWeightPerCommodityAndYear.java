...
/**
 * Practice 9: average traded weight (kg) per commodity and year.
 *
 ...
 */
public class AverageWeightPerCommodityAndYear {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        String outputPath = System.getProperty("user.home") + "/Desktop/" + AverageWeightPerCommodityAndYear.class.getSimpleName();
        if (args.length == 2) {
            inputPath = args[0];
            outputPath = args[1];
        }

        Job job = Job.getInstance(new Configuration(), AverageWeightPerCommodityAndYear.class.getSimpleName());
        job.setJarByClass(AverageWeightPerCommodityAndYear.class);
