...
/**
 * Practice 2: number of Brazilian transactions per commodity.
 *
 ...
 */
public class BrazilTransactionsPerCommodity {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        String outputPath = System.getProperty("user.home") + "/Desktop/" + BrazilTransactionsPerCommodity.class.getSimpleName();
        if (args.length == 2) {
            inputPath = args[0];
            outputPath = args[1];
        }

        Job job = Job.getInstance(new Configuration(), BrazilTransactionsPerCommodity.class.getSimpleName());
        job.setJarByClass(BrazilTransactionsPerCommodity.class);
