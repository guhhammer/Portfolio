...
/**
 * Practice 5: number of transactions per commodity in 2016.
 *
...
public class TransactionsPerCommodityIn2016 {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        String outputPath = System.getProperty("user.home") + "/Desktop/" + TransactionsPerCommodityIn2016.class.getSimpleName();
        if (args.length == 2) {
            inputPath = args[0];
            outputPath = args[1];
        }

        Job job = Job.getInstance(new Configuration(), TransactionsPerCommodityIn2016.class.getSimpleName());
        job.setJarByClass(TransactionsPerCommodityIn2016.class);
