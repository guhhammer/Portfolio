...
/**
 * Practice 8: total traded weight (kg) per commodity and year.
 *
 ...
 */
public class TotalWeightPerCommodityAndYear {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        String outputPath = System.getProperty("user.home") + "/Desktop/" + TotalWeightPerCommodityAndYear.class.getSimpleName();
        if (args.length == 2) {
            inputPath = args[0];
            outputPath = args[1];
        }

        Job job = Job.getInstance(new Configuration(), TotalWeightPerCommodityAndYear.class.getSimpleName());
        job.setJarByClass(TotalWeightPerCommodityAndYear.class);
