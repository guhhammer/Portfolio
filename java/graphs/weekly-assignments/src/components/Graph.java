...
import components.SparseMatrix.*;
...
public class Graph{
    ...
    List getComponents(){ return BreadthFirstSearch.componentsOf(this); }
    
    // returns the number of components.
    int componentCount(){
        return BreadthFirstSearch.componentsOf(this).size();
    }
    
    // prints only the components.
    void printOnlyComponents(){
        BreadthFirstSearch.printOnlyComponents(BreadthFirstSearch.componentsOf(this));
    }
    
    // prints the components and their count.
    void printComponents(){ 
        BreadthFirstSearch.printComponents(BreadthFirstSearch.componentsOf(this));
    }   
