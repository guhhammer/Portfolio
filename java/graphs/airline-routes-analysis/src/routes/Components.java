...
public class Components {
    ...
    // runs the search and returns the component.
    ...
    // removes duplicate components (undirected graph).
    ...
    // merges overlapping components (directed graph).
    private static void distinctDirected(ArrayList<int[]> aux){
	...
	private static List getComponents(Graph g){
        ...
        if(g.directed) {
        	...
        	distinctDirected(aux); // remove duplicates.
        	distinctDirected(aux); // remove duplicates.
