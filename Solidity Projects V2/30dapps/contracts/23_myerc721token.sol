...
contract MyERC721 is ERC721 {
    ...
    mapping(uint256 => address) internal idToApproved;
    ...
    function _safeTransferFrom(address _from, address _to, uint256 _tokenId, bytes memory _data) internal {
        ...
        if(_to.isContract()) {
            ...
            require(retval == MAGIC_ON_ERC721_RECEIVED, "recipient on SC cannot handle ERC721 tokens");
    ...
    function _transfer(address _from, address _to, uint256 _tokenId) internal canTransfer(_tokenId) {
        ...
        require(_from == idToOwner[_tokenId], "not authorized to transfer tokenId");
